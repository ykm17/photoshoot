...
import com.project.photoshoot.adapters.AppointmentAdapter;
...
public class AppointmentActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener {
    ...
    private TextView mSelectedDate, mSelectedTime;
    ...
    private void pushData() {
        ...
        mDatabaseReference.push().setValue(
                new Appointment(mBookingNameEditText.getText() + "",
    ...
    public void onDateSet(DatePickerDialog view, int year, int monthOfYear, int dayOfMonth) {
        ...
        Toast.makeText(AppointmentActivity.this, String.format("Date: %d/%d/%d", monthOfYear, dayOfMonth, year), Toast.LENGTH_SHORT).show();
    ...
    public void onTimeSet(TimePickerDialog view, int hourOfDay, int minute, int second) {
        ...
        Toast.makeText(getApplicationContext(), String.format("Time: %d:%d", hourOfDay, minute), Toast.LENGTH_SHORT).show();
